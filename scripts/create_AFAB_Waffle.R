...
AFAB_Waffle1 <- waffle(AFAB_Comb_Sum[1, 4:6]*100, 
       rows=10, 
       size=0.6,
       flip = T,
       reverse = F,
...
AFAB_Waffle2 <- waffle(AFAB_Comb_Sum[2, 4:6]*100, 
  ...
  scale_fill_manual(name = NULL, 
                    values = c("#ed7b84", "#FADF75","#5bc2a3"), 
                    labels = c(paste(AFAB_Comb_Sum[2,4]*100, "%"), 
                               paste(AFAB_Comb_Sum[2,5]*100, "%"),
                               paste(AFAB_Comb_Sum[2,6]*100, "%"))
  )


AFAB_Waffle3 <- waffle(AFAB_Comb_Sum[3, 4:6]*100, 
                       rows=10, 
                       size=0.6,
                       flip = T,
                       reverse = F,
  ...
  scale_fill_manual(name = NULL, 
                    values = c("#ed7b84", "#FADF75","#5bc2a3"), 
                    labels = c(paste(AFAB_Comb_Sum[3,4]*100, "%"), 
                               paste(AFAB_Comb_Sum[3,5]*100, "%"),
                               paste(AFAB_Comb_Sum[3,6]*100, "%"))
  )


AFAB_Waffle4 <- waffle(AFAB_Comb_Sum[4, 4:6]*100, 
                       rows=10, 
                       size=0.6,
                       flip = T,
                       reverse = F,
  ...
  scale_fill_manual(name = NULL, 
                    ...
                    labels = c(paste(AFAB_Comb_Sum[4,4]*100, "%"), 
                               paste(AFAB_Comb_Sum[4,5]*100, "%"),
                               paste(AFAB_Comb_Sum[4,6]*100, "%")),
                    breaks= colnames(AFAB_Comb_Sum[4:6])
  )

AFAB_Waffle5 <- waffle(AFAB_Comb_Sum[5, 4:6]*100, 
                       rows=10, 
                       size=0.6,
                       flip = T,
                       reverse = F,
  ...
  scale_fill_manual(name = NULL, 
                    values = c("#ed7b84", "#FADF75","#5bc2a3"), 
                    labels = c(paste(AFAB_Comb_Sum[5,4]*100, "%"), 
                               paste(AFAB_Comb_Sum[5,5]*100, "%"),
                               paste(AFAB_Comb_Sum[5,6]*100, "%"))
)

AFAB_Waffle6 <- waffle(AFAB_Comb_Sum[6, 4:6]*100, 
                       rows=10, 
                       size=0.6,
                       flip = T,
                       reverse = F,
...
AFAB_Waffle7 <- waffle(AFAB_Comb_Sum[7, 4:6]*100, 
  ...
  scale_fill_manual(name = NULL, 
                    values = c("#ed7b84", "#FADF75","#5bc2a3"), 
                    labels = c(paste(AFAB_Comb_Sum[7,4]*100, "%"), 
                               paste(AFAB_Comb_Sum[7,5]*100, "%"),
                               paste(AFAB_Comb_Sum[7,6]*100, "%")                               )
  )

AFAB_Waffle8 <- waffle(AFAB_Comb_Sum[8, 4:6]*100, 
                       rows=10, 
                       size=0.6,
                       flip = T,
                       reverse = F,
  ...
  scale_fill_manual(name = NULL, 
                    values = c("#ed7b84", "#FADF75","#5bc2a3"), 
                    labels = c(paste(AFAB_Comb_Sum[8,4]*100, "%"), 
                               paste(AFAB_Comb_Sum[8,5]*100, "%"),
